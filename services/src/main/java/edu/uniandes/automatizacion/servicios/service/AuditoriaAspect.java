package edu.uniandes.automatizacion.servicios.service;
...
import edu.uniandes.automatizacion.servicios.comun.DateTimeUtil;
import edu.uniandes.automatizacion.servicios.comun.RequestScope;
 ...
 * paquete edu.uniandes.automatizacion.servicios.service).
 *
 */
@Aspect
@Component
public class AuditoriaAspect {
	 ...
	 */
	@Pointcut("within(edu.uniandes.automatizacion.servicios.service.catalogo..*)")
	public void loggingPointcut() {
		// Method is empty as this is just a Poincut, the implementations are in
		// the advices.
	}

	@Pointcut("within(edu.uniandes.automatizacion.servicios.dao.catalogo..*) || "
